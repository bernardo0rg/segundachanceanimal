...
<nav>
    ...
    <a href="index.php">Animais para Adoção</a>
    <a href="index.php">Como Ajudar</a>
    <a href="index.php">Parceiros</a>
    <a href="index.php">Contato</a>
    <a href="loginuser.php">administração</a>
    <a href="loginuser.php">login usuario</a>
    <a href="cadastrar.php">cadastro</a>
    <a href="administracao.php">cadastrar pets</a>
</nav>
    ...
    <div class="container buttons-section">
       ...
       <a href="doacao.php" class="btn">Doar Agora</a>
        ...
        <a href="cadastrar.php" class="btn">Inscrever-se</a>
    </div>
